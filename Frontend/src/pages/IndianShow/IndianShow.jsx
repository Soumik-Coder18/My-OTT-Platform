...
import { Tv, Star, Filter, Sparkles, ChevronDown } from 'lucide-react';
...
const IndianShow = () => {
  ...
  const fetchShows = async (langCode, currentPage) => {
    setLoading(true);
    try {
        ...
        <div className="relative z-10 max-w-7xl mx-auto">
          ...
          >
            ...
            >
              ...
              <span className="font-semibold text-sm md:text-base">Indian Television & Web Series</span>
            </motion.div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            <div className="flex items-center gap-2 md:gap-3">
              <Tv className="w-5 h-5 md:w-6 md:h-6 text-purple-300" />
