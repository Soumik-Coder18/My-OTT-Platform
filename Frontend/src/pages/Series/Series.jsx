...
import { SearchX, MonitorPlay, Film, Star, Play, ExternalLink } from 'lucide-react';
...
const Series = () => {
  ...
  // Get featured series for hero section
  const featuredSeries = seriesList[0];

  const handleWatchNow = () => {
    if (!featuredSeries) return;
    const searchQuery = encodeURIComponent(`${featuredSeries.name} tv show streaming`);
  ...
  const handleMoreInfo = () => {
    if (!featuredSeries) return;
    navigate(`/series/${featuredSeries.id}`);
  };
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 relative overflow-hidden">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 md:gap-6">
            ...
            <div className="flex items-center gap-3 md:gap-4">
              ...
              <div>
                ...
                <p className="text-gray-300 text-sm md:text-lg">
                  Discover the latest and greatest TV series
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-wrap gap-2 md:gap-4 w-full md:w-auto">
              ...
              >
                ...
                <span className="hidden sm:inline">Indian Shows</span>
      ...
      {/* Hero Section - Featured Series Banner */}
      {featuredSeries && (
        <motion.section 
            ...
            <div className="absolute inset-0 flex flex-col justify-end p-3 sm:p-4 md:p-6 lg:p-8 xl:p-12">
              ...
              >
                ...
                >
                  ...
                  <span className="hidden xs:inline">Featured Series</span>
                ...
                >
                  <div className="flex items-center gap-1">
                    ...
                    <span>{featuredSeries.vote_average?.toFixed(1) || 'N/A'}</span>
                  </div>
                  <div className="flex items-center gap-1">
                    <span>{featuredSeries.first_air_date?.slice(0, 4) || 'N/A'}</span>
                  </div>
                  <div className="hidden sm:flex items-center gap-1">
                    <span>{featuredSeries.vote_count?.toLocaleString() || '0'} votes</span>
                  </div>
                </motion.div>
                ...
                >
                  {featuredSeries.overview || 'No description available'}
                </motion.p>
      ...
      <div className="px-4 py-8 md:py-16">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <h2 className="text-xl md:text-2xl font-bold text-white">All Series</h2>
          </motion.div>
          ...
          <AnimatePresence mode="wait">
            {seriesList.length > 0 ? (
              ...
              >
                ...
                <p className="text-gray-300 text-lg">Try changing your filters to discover more series</p>
              </motion.div>
            )}
                    </AnimatePresence>
        </div>
