...
const SearchResults = () => {
      ...
      >
        <Link to={path}>
          <div className="bg-gradient-to-br from-white/5 to-white/10 backdrop-blur-sm border border-white/10 hover:border-purple-500/30 transition-all duration-300 hover:shadow-2xl hover:shadow-purple-500/20 rounded-xl overflow-hidden">
            ...
            {/* Content */}
            <div className="p-3">
              <h3 className="text-white font-bold text-sm mb-2 line-clamp-2 group-hover:text-purple-300 transition-colors duration-300">
                {title}
              </h3>
  ...
  const ListCard = ({ item, index }) => {
    ...
    return (
      ...
      >
        <Link to={path}>
          <div className="flex items-center gap-4 p-4 bg-gradient-to-r from-white/5 to-white/10 backdrop-blur-sm border border-white/10 hover:border-purple-500/30 transition-all duration-300 hover:shadow-xl hover:shadow-purple-500/20 rounded-xl">
            {/* Image */}
            ...
            <div className="flex-1 min-w-0">
              <h3 className="text-white font-bold text-lg mb-2 group-hover:text-purple-300 transition-colors duration-300 truncate">
                {title}
              </h3>
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="relative z-10 p-8">
          ...
          >
            ...
            {/* Controls Bar */}
            <div className="flex flex-col sm:flex-row gap-4 items-center justify-between mb-8 p-4 bg-white/5 backdrop-blur-sm rounded-xl border border-white/10">
              {/* Filters */}
              <div className="flex items-center gap-4">
                <button
                  onClick={() => setShowFilters(!showFilters)}
                  className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-purple-500 to-pink-500 text-white font-semibold rounded-lg hover:from-purple-600 hover:to-pink-600 transition-all duration-300"
                >
